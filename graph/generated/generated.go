...
type ComplexityRoot struct {
	...
	Query struct {
		...
		GetUser     func(childComplexity int, address string) int
...
type QueryResolver interface {
	...
	GetUser(ctx context.Context, address string) (*models.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.addListing":
		...
		return e.complexity.Mutation.AddListing(childComplexity, args["input"].(model.PropertyInput)), true
	...
	case "Mutation.makeOffer":
		...
		return e.complexity.Mutation.MakeOffer(childComplexity, args["input"].(model.OfferInput)), true
	...
	case "Offer.drafted":
		if e.complexity.Offer.Drafted == nil {
			break
		}

		return e.complexity.Offer.Drafted(childComplexity), true
	...
	case "Query.getUser":
		...
		return e.complexity.Query.GetUser(childComplexity, args["address"].(string)), true
...
func (ec *executionContext) field_Mutation_addListing_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.PropertyInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNPropertyInput2githubᚗcomᚋ3dw1nM0535ᚋgalvaᚋgraphᚋmodelᚐPropertyInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_addListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddListing(rctx, args["input"].(model.PropertyInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_makeOffer(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Mutation_makeOffer_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
...
func (ec *executionContext) _Offer_drafted(ctx context.Context, field graphql.CollectedField, obj *models.Offer) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_getUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetUser(rctx, args["address"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "addListing":
			out.Values[i] = ec._Mutation_addListing(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "makeOffer":
			out.Values[i] = ec._Mutation_makeOffer(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "acceptOffer":
...
func (ec *executionContext) _Offer(ctx context.Context, sel ast.SelectionSet, obj *models.Offer) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "drafted":
			out.Values[i] = ec._Offer_drafted(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		default:
...
func (ec *executionContext) unmarshalNPropertyInput2githubᚗcomᚋ3dw1nM0535ᚋgalvaᚋgraphᚋmodelᚐPropertyInput(ctx context.Context, v interface{}) (model.PropertyInput, error) {
